...
from app.schemas.users import SignupRes
...
@router.get("/all_users", status_code=HTTPStatus.OK, response_model=List[SignupRes])
...
@router.get("/me", status_code=HTTPStatus.OK, response_model=SignupRes)
